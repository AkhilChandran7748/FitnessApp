        ...
        return (
            <>
                <div className="col-sm-12 col-md-6 col-lg-4 mb-4 d-flex justify-content-center">
                    <div className="_metric_card" style={{ width: "90%" }}>
                        <div className="card-body" onClick={(rowData) => {
                            onWeeklyUpdateCardClick(rowData, index);
                        }}>
                            ...
                            <div className="row">
                                <div className="col-6 text-center">
                                    <div className="card_metrics_border">
                                        <span className="text-center">Weight</span><br />
                                        <img src={`/icons/weight_measure.png`} alt={"weight"} className="w-6 shadow-2" />
                                        <span>
                                            <p className="mt-0 mb-3">{rowData.Weight} {UNITS.WEIGHT.KILO} {getArrow(rowData.WeightDifference)} {rowData.WeightDifference} </p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="col-6 text-center" >
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/chest_measure.png`} alt={"bodyFat"} className="w-6 shadow-2" />
                                        <span>
                                            <p className="mt-0 mb-3">{rowData.BodyFat} {UNITS.WEIGHT.KILO} {rowData.BodyFatDifference} {getArrow(rowData.BodyFatDifference)}</p>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 text-center" >
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/waist_measure.png`} alt={"waist"} className="w-6 shadow-2" />
                                        <span>
                                ...
                                <div className="col-6 text-center" >
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/hip_measure.png`} alt={"bodyHip"} className="w-6 shadow-2" />
                                        <span>
                            ...
                            <div className="row">
                                <div className="col-6 text-center" >
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/neck_measure.png`} alt={"neck"} className="w-6 shadow-2" />
                                        <span>
                                ...
                                <div className="col-6 text-center" >
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/chest_measure.png`} alt={"chest"} className="w-6 shadow-2" />
                                        <span>
                            ...
                            <div className="row">
                                <div className="col-6 text-center">
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/upper_arm_measure.png`} alt={"upperArm"} className="w-6 shadow-2" />
                                        <span>
                                ...
                                <div className="col-6 text-center">
                                    <div className="card_metrics_border">
                                        ...
                                        <img src={`/icons/thigh_measure.png`} alt={"quadriceps"} className="w-6 shadow-2" />
                                        <span>
