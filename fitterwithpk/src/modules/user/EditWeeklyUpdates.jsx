...
const EditWeeklyUpdates = ({ visible, setVisible, data: eData, reload }) => {
    ...
    const onSubmit = (data) => {
        ...
        //     }
        // }
        formdata.append("IdWeeklyStats", eData.IdWeeklyStats);
    ...
    // }
    return (
        <Dialog position={'top'} header={" Edit Weekly Updates"} visible={visible} style={{ width: '100% !important' }} onHide={() => { if (!visible) return; setVisible(false); }}>
...
export default EditWeeklyUpdates
